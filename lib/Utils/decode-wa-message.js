...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const participantAlt = stanza.attrs.participant_pn;
    ...
    const key = Object.fromEntries(
        Object.entries({
            remoteJid: chatId,
            remoteJidAlt: !(0, WABinary_1.isJidGroup)(chatId) ? (fromMe ? addressingContext.recipientAlt : addressingContext.senderAlt) : (chatId !== addressingContext.recipientAlt && !fromMe ? addressingContext.recipientAlt : null),
            fromMe,
            id: msgId,
            senderPn,
            ...
            participantAlt: (0, WABinary_1.isJidGroup)(chatId) ? participantAlt : undefined,
    ...
    const fullMessage = {
        ...
        mode: addressingContext.addressingMode
    }
