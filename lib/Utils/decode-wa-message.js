...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const participantLid = (_c = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null || _c === void 0 ? void 0 : _c.participant;
    ...
    if ((0, WABinary_1.isJidUser)(from) || (0, WABinary_1.isLidUser)(from)) {
        ...
        fromMe = (0, WABinary_1.isLidUser)(from) ? isMeLid(from) : (0, WABinary_1.isJidUser)(from) ? isMeJid(from) : false;
        msgType = 'chat';
        author = from;
    }
       ...
       if (!participant) {
        ...
        fromMe = (0, WABinary_1.isLidUser)(participant) ? isMeLid(participant) : (0, WABinary_1.isJidUser)(participant) ? isMeJid(participant) : false;
        msgType = 'group';
        author = participant;
        chatId = from;
    }
  ...
  if(chatId && chatId.endsWith("@lid") && senderPn && senderPn.endsWith("@s.whatsapp.net")) chatId = senderPn;
const key = Object.fromEntries(
    Object.entries({
        ...
        id: msgId,
        senderPn,
        senderLid: senderLid ? senderLid : (0, WABinary_1.isLidUser)(from) ? from : null,
        participant,
        participantLid,
        'server_id': stanza.attrs?.server_id
    }).filter(([_, value]) => value != null) // كايحيد أي حاجة null أو undefined
);
    const fullMessage = {
        key,
