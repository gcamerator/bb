...
exports.Browsers = {
    ...
    // تصحيح أندرويد ليتوافق مع التعديلات السابقة
    android: (version = '15') => ['Android', 'android', version],
    and_roid: (version = '15') => ['And_roid', 'and_roid', version],
    /** التعرف التلقائي بناءً على نظام التشغيل الحالي */
...
const getPlatformId = (browser) => {
    ...
    if (key === 'ANDROID' || key === 'AND_ROID') {
        return WAProto_1.proto.DeviceProps.PlatformType.ANDROID_PHONE.toString();
    }
    const platformType = WAProto_1.proto.DeviceProps.PlatformType[key];
    return platformType ? platformType.toString() : '49'; // الافتراضي Chrome
};
