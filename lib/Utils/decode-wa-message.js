...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    if ((0, WABinary_1.isJidUser)(from) || (0, WABinary_1.isLidUser)(from)) {
        ...
        fromMe = (0, WABinary_1.isLidUser)(from) ? isMeLid(from) : isMeJid(from);
        msgType = 'chat';
        author = from;
    } 
    ...
    const key = Object.fromEntries(
        Object.entries({
            ...
            participant: (0, WABinary_1.isJidGroup)(from) ? participant : undefined,
            participantLid: (0, WABinary_1.isJidGroup)(from) ? participantLid : undefined,
