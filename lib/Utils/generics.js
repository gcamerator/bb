...
const getPlatformId = (browser) => {
     console.log("GENIRICS:/n", "browser:", browser)
...
const generateMessageIDV2 = (userId) => {
    ...
    return 'MDSN-' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'MDSN-' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
