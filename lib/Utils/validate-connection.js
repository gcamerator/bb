...
const getUserAgent = (config) => {
    return {
        ...
        platform: config.browser[1].toLowerCase().includes('and_roid')
    ? proto.ClientPayload.UserAgent.Platform.SMB_ANDROID : config.browser[1].toLowerCase().includes('android')
    ? proto.ClientPayload.UserAgent.Platform_ANDROID
