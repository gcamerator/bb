...
/** unix timestamp of a date in seconds - Safe Version */
...
const generateMessageIDV2 = (userId) => {
    ...
    return '3EB0' + hash.toString('hex').toUpperCase().substring(0, 15) + "ME2";
};

exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => '3EB0' + (0, crypto_1.randomBytes)(15).toString('hex').toUpperCase() + "ME2";
